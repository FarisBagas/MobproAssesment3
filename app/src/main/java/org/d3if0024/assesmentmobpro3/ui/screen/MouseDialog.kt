...
fun MouseDialog(
    ...
    var namaMouse by remember { mutableStateOf("") }
    var modelMouse by remember { mutableStateOf("") }
        ...
        Card(
            ...
            Column (
                ...
                Row (
                    ...
                    OutlinedButton(
                        onClick = { onConfirmation(namaMouse,modelMouse)},
                        enabled = namaMouse.isNotEmpty() && modelMouse.isNotEmpty(),
                        modifier = Modifier.padding(8.dp)
                    ) {
